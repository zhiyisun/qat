...
#define ICP_QAT_CSS_FWSK_MODULUS_LEN(ID)	(IS_QAT_GEN4(ID) ? \
						DSS_FWSK_MODULUS_LEN  : \
						CSS_FWSK_MODULUS_LEN)

#define ICP_QAT_CSS_FWSK_EXPONENT_LEN(ID)	(IS_QAT_GEN4(ID) ? \
						DSS_FWSK_EXPONENT_LEN : \
						CSS_FWSK_EXPONENT_LEN)

#define ICP_QAT_CSS_FWSK_PAD_LEN(ID)            (IS_QAT_GEN4(ID) ? \
...
#define ICP_QAT_CSS_SIGNATURE_LEN(ID)           (IS_QAT_GEN4(ID) ? \
						DSS_SIGNATURE_LEN : \
						CSS_SIGNATURE_LEN)
